...
By default, dahomeyd will dump mempool on shutdown and
...
class MempoolPersistTest(DahomeyTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent dahomeyd from writing mempool.dat to disk. Verify that `savemempool` fails")
