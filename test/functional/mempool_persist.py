...
By default, danxomed will dump mempool on shutdown and
...
class MempoolPersistTest(DanxomeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent danxomed from writing mempool.dat to disk. Verify that `savemempool` fails")
