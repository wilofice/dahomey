...
"""
Test starting danxomed with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(DanxomeTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that danxomed has bound on "::1" (for RPC) and "::" (for P2P).
