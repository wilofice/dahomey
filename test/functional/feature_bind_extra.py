...
"""
Test starting dahomeyd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(DahomeyTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that dahomeyd has bound on "::1" (for RPC) and "::" (for P2P).
