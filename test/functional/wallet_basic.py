...
class WalletTest(DahomeyTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DEY from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 DEY with subtract fee from amount
        ...
        # Sendmany 10 DEY with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Dahomey address
            assert_raises_rpc_error(-5, "Invalid Dahomey address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Dahomey address
            assert_raises_rpc_error(-5, "Invalid Dahomey address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Dahomey address or script", self.nodes[0].importaddress, "invalid")
