...
"""Verify that starting danxome with -h works as expected."""

from test_framework.test_framework import DanxomeTestFramework
from test_framework.util import assert_equal

class HelpTest(DanxomeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start danxome with -h for help text")
        ...
        self.log.info("Start danxome with -version for version information")
        ...
        self.log.info("Start danxomed with -fakearg to make sure it does not start")
