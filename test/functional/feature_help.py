...
"""Verify that starting dahomey with -h works as expected."""

from test_framework.test_framework import DahomeyTestFramework
from test_framework.util import assert_equal

class HelpTest(DahomeyTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dahomey with -h for help text")
        ...
        self.log.info("Start dahomey with -version for version information")
        ...
        self.log.info("Start dahomeyd with -fakearg to make sure it does not start")
