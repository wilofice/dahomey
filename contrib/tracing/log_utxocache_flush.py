...
"""Example logging Danxome Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/danxomed
...
def main(danxomed_path):
    ...
    b = BPF(text=program, usdt_contexts=[danxomed_with_usdts])
