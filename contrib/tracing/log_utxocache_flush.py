...
"""Example logging Dahomey Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/dahomeyd
...
def main(dahomeyd_path):
    ...
    b = BPF(text=program, usdt_contexts=[dahomeyd_with_usdts])
