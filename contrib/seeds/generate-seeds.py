...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef DANXOME_CHAINPARAMSSEEDS_H\n')
    g.write('#define DANXOME_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the danxome network\n')
    ...
    g.write('#endif // DANXOME_CHAINPARAMSSEEDS_H\n')
