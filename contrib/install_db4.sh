...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the danxome repository."
  exit 1
fi
...
# See https://github.com/danxome/danxome/issues/16064
...
echo 'When compiling danxomed, run `./configure` in the following way:'
echo
