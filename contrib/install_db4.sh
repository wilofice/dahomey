...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the dahomey repository."
  exit 1
fi
...
# See https://github.com/dahomey/dahomey/issues/16064
...
echo 'When compiling dahomeyd, run `./configure` in the following way:'
echo
