...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > "${HOME}/Library/Application Support/Dahomey"
else
  DOCKER_EXEC echo \> \$HOME/.dahomey
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/dahomey/dahomey/pull/18288#discussion_r433189350 for
  # details.
