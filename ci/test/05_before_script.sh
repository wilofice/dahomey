...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > "${HOME}/Library/Application Support/Danxome"
else
  DOCKER_EXEC echo \> \$HOME/.danxome
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/danxome/danxome/pull/18288#discussion_r433189350 for
  # details.
