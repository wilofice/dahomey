...
#ifndef DANXOME_CRYPTO_CHACHA_POLY_AEAD_H
#define DANXOME_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@danxome.
 *
 ...
 *
 * The chacha20-poly1305@danxome combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@danxome cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@danxome are relatively fast in
...
#endif // DANXOME_CRYPTO_CHACHA_POLY_AEAD_H
