...
/* A AEAD class for ChaCha20-Poly1305@dahomey.
 *
 ...
 *
 * The chacha20-poly1305@dahomey combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@dahomey cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@dahomey are relatively fast in
