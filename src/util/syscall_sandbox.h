...
#ifndef DANXOME_UTIL_SYSCALL_SANDBOX_H
#define DANXOME_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during danxomed initialization if Danxome Core was compiled
...
#endif // DANXOME_UTIL_SYSCALL_SANDBOX_H
