...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2022", "::ffff:127.0.0.1", 2022));
    BOOST_CHECK(TestSplitHost("[::]:2022", "::", 2022));
    BOOST_CHECK(TestSplitHost("::2022", "::2022", 0));
    BOOST_CHECK(TestSplitHost(":2022", "", 2022));
    BOOST_CHECK(TestSplitHost("[]:2022", "", 2022));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2022", "127.0.0.1:2022"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2022", "[::]:2022"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
