...
#ifndef DANXOME_TEST_SCRIPTNUM10_H
#define DANXOME_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Danxome Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // DANXOME_TEST_SCRIPTNUM10_H
