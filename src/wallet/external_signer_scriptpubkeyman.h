...
#ifndef DANXOME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DANXOME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DANXOME_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
