...
#ifndef DANXOME_WALLET_TRANSACTION_H
#define DANXOME_WALLET_TRANSACTION_H
...
public:
     ...
     * on this danxome node, and set to 0 for transactions that were created
...
#endif // DANXOME_WALLET_TRANSACTION_H
