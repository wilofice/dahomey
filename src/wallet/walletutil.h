...
#ifndef DANXOME_WALLET_WALLETUTIL_H
#define DANXOME_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! danxome from opening the wallet, thinking it was newly created, and
...
#endif // DANXOME_WALLET_WALLETUTIL_H
