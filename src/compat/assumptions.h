...
#ifndef DANXOME_COMPAT_ASSUMPTIONS_H
#define DANXOME_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Danxome cannot be compiled without assertions."
#endif
...
#endif // DANXOME_COMPAT_ASSUMPTIONS_H
