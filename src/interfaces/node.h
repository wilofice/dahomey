...
#ifndef DANXOME_INTERFACES_NODE_H
#define DANXOME_INTERFACES_NODE_H
...
//! Top-level interface for a danxome node (danxomed process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // DANXOME_INTERFACES_NODE_H
