...
/**
  Dahomey GUI main class. This class represents the main window of the Dahomey UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DahomeyGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DahomeyGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~DahomeyGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a dahomey wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Dahomey Transaction from file or clipboard */
