    ...
    platformStyle(_platformStyle)
{
    ...
    // normal danxome address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying danxome address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DanxomeAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
