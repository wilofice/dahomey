    ...
    platformStyle(_platformStyle)
{
    ...
    // normal dahomey address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying dahomey address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DahomeyAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
