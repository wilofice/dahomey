...
#ifndef DANXOME_QT_RECEIVECOINSDIALOG_H
#define DANXOME_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of danxomes */
...
#endif // DANXOME_QT_RECEIVECOINSDIALOG_H
