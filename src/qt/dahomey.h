...
/** Main Dahomey application object */
class DahomeyApplication: public QApplication
{
    Q_OBJECT
public:
    explicit DahomeyApplication();
    ~DahomeyApplication();
    ...
    /// Get window identifier of QMainWindow (DahomeyGUI)
...
Q_SIGNALS:
    ...
    void splashFinished();
    void windowShown(DahomeyGUI* window);
