...
/**
  Danxome GUI main class. This class represents the main window of the Danxome UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DanxomeGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DanxomeGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~DanxomeGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a danxome wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Danxome Transaction from file or clipboard */
