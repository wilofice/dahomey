...
This document provides guidelines for internationalization of the Danxome Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `danxome_en.ts` remains unchanged.
