...
This document provides guidelines for internationalization of the Dahomey Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `dahomey_en.ts` remains unchanged.
