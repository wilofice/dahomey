...
Assumeutxo is a feature that allows fast bootstrapping of a validating danxomed
...
- [Github issue](https://github.com/danxome/danxome/issues/15605)
- [draft PR](https://github.com/danxome/danxome/pull/15606)
...
considered active. This is the "traditional" mode of operation for danxomed.
...
**Failure consideration:** if danxomed unexpectedly halts after `m_stop_use` is set on
...
### Danxomed restarts sometime after snapshot validation has completed

When danxomed initializes again, what began as the snapshot chainstate is now
