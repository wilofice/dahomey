...
Assumeutxo is a feature that allows fast bootstrapping of a validating dahomeyd
...
- [Github issue](https://github.com/dahomey/dahomey/issues/15605)
- [draft PR](https://github.com/dahomey/dahomey/pull/15606)
...
considered active. This is the "traditional" mode of operation for dahomeyd.
...
**Failure consideration:** if dahomeyd unexpectedly halts after `m_stop_use` is set on
...
### Dahomeyd restarts sometime after snapshot validation has completed

When dahomeyd initializes again, what began as the snapshot chainstate is now
