Danxome Core version 0.14.2 is now available from:

  <https://danxome.org/bin/danxome-core-0.14.2/>
...
(in Danxome Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate danxome-config.h as necessary (theuni)
