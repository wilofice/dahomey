Dahomey Core version 0.14.2 is now available from:

  <https://dahomey.org/bin/dahomey-core-0.14.2/>
...
(in Dahomey Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate dahomey-config.h as necessary (theuni)
