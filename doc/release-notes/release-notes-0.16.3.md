Danxome Core version 0.16.3 is now available from:

  <https://danxomecore.org/bin/danxome-core-0.16.3/>
...
been discovered in Danxome Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` danxomeconsensus: invalid flags error should be set to `danxomeconsensus_err` (afk11)
