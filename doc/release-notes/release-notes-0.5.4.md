Danxome version 0.5.4 is now available for download at:
http://sourceforge.net/projects/danxome/files/Danxome/danxome-0.5.4/
...
http://gitorious.org/danxome/danxomed-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Danxome-Qt notifications under Growl 1.3.
Increase required age of Danxome-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDanxome properly when installing Danxome-Qt over it. (Windows)
