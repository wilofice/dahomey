Dahomey version 0.5.4 is now available for download at:
http://sourceforge.net/projects/dahomey/files/Dahomey/dahomey-0.5.4/
...
http://gitorious.org/dahomey/dahomeyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Dahomey-Qt notifications under Growl 1.3.
Increase required age of Dahomey-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDahomey properly when installing Dahomey-Qt over it. (Windows)
