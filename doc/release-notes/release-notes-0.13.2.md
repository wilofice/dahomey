Danxome Core version 0.13.2 is now available from:

  <https://danxome.org/bin/danxome-core-0.13.2/>
...
- #8908 `4a974b2` Update danxome-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow danxome-tx to create v2 transactions (btcdrak)
