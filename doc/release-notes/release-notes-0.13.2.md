Dahomey Core version 0.13.2 is now available from:

  <https://dahomey.org/bin/dahomey-core-0.13.2/>
...
- #8908 `4a974b2` Update dahomey-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow dahomey-tx to create v2 transactions (btcdrak)
