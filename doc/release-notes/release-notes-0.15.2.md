Danxome Core version *0.15.2* is now available from:

  <https://danxomecore.org/bin/danxome-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in danxome-tx (TheBlueMatt)
