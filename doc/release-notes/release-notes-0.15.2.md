Dahomey Core version *0.15.2* is now available from:

  <https://dahomeycore.org/bin/dahomey-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in dahomey-tx (TheBlueMatt)
