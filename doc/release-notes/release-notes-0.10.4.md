Dahomey Core version 0.10.4 is now available from:

  <https://dahomey.org/bin/dahomey-core-0.10.4/>
...
- #6953 `43c2789` Split dahomey-tx into its own package
- #6953 `dfe0d4d` Include dahomey-tx binary on Debian/Ubuntu
