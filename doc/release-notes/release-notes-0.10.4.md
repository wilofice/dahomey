Danxome Core version 0.10.4 is now available from:

  <https://danxome.org/bin/danxome-core-0.10.4/>
...
- #6953 `43c2789` Split danxome-tx into its own package
- #6953 `dfe0d4d` Include danxome-tx binary on Debian/Ubuntu
