...
Dahomey Core version 0.19.1 is now available from:

  <https://dahomeycore.org/bin/dahomey-core-0.19.1/>
...
From Dahomey Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Dahomey Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Dahomey Core does not yet change appearance when
...
- #17488 fix "dahomeyd already running" warnings on macOS (fanquake)
