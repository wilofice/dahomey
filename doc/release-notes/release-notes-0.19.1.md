...
Danxome Core version 0.19.1 is now available from:

  <https://danxomecore.org/bin/danxome-core-0.19.1/>
...
From Danxome Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Danxome Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Danxome Core does not yet change appearance when
...
- #17488 fix "danxomed already running" warnings on macOS (fanquake)
