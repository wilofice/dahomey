Danxome Core version 0.18.0 is now available from:
...
- Since version 0.16.0, Danxome Core’s built-in wallet has defaulted to
...
- On macOS, Danxome Core now opts out of application CPU throttling
