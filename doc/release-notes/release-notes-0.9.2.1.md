Danxome Core version 0.9.2.1 is now available from:

  https://danxome.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DAN to 0.01 DAN
...
- Fix "Start danxome on system login"
