Dahomey Core version 0.9.2.1 is now available from:

  https://dahomey.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DEY to 0.01 DEY
...
- Fix "Start dahomey on system login"
